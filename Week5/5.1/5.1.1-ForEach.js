...
data.forEach(userObj =>
  jargon.push(`${userObj.company.catchPhrase} ${userObj.company.bs}`)
);
console.log(jargon);
...
console.log(classWeeks);
classWeeks.forEach(
  (htmlElement, i) =>
    (htmlElement.textContent = `text content has changed, this is now class week ${i}`)
);
